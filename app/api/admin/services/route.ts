    ...
    const result = await prisma.$transaction(async (tx) => {
      const pricingRule = await tx.pricingRule.create({
        data: {
          ...
          controllerPricingEnabled: input.controllerPricingEnabled,
          multiplayerHalfHourPrice: input.multiplayerHalfHourPrice,
          multiplayerHourPrice: input.multiplayerHourPrice,
